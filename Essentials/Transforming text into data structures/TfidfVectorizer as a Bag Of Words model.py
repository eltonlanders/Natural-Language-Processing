# -*- coding: utf-8 -*-
"""
Created on Thu May 20 20:09:26 2021
...
# Building a BoW model using TfidfVectorizer 
...
print(tf_idf_matrix.toarray().shape) # no of sentences (documents) * len of vocab

# Including bigrams and trigrams
vectorizer_ngram_range = TfidfVectorizer(analyzer='word', ngram_range=(1,3))
...
vectorizer_max_features = TfidfVectorizer(analyzer='word', 
                                          ngram_range=(1,3), 
                                          max_features = 50)
...
l2: Sum of squares of vector elements is 1. This is the default.
l1: Sum of absolute values of vector elements is 1.    
'''
vectorizer_l1_norm = TfidfVectorizer(norm="l1") # using l1 norm
tf_idf_matrix_l1_norm = vectorizer_l1_norm.fit_transform(preprocessed_corpus)
feature_names_l1 = vectorizer_l1_norm.get_feature_names()
feature_array_l1 = tf_idf_matrix_l1_norm.toarray()
print("\nThe shape of the TF-IDF matrix is: ", tf_idf_matrix_l1_norm.shape)

# Using N-grams and Max features with TfidfVectorizer
...
feature_names_l2_n_max = vectorizer_n_gram_max_features.get_feature_names()
feature_array_l2_n_max = tf_idf_matrix_n_gram_max_features.toarray()
